...
<html>
  <head>
    ...
    <title>My JSP 'UserUpdateInf.jsp' starting page</title>
...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-21" data-genuitec-path="/Outlet/WebRoot/jsp/UserUpdateInf.jsp">

		<div id="conner" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-21" data-genuitec-path="/Outlet/WebRoot/jsp/UserUpdateInf.jsp">
			<form action = "<%=basePath%>/servlet/UserUpdateInf"  method="post">
				<table class="t">
					<tr>
